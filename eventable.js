...
(function() {
  "use strict";
  var Eventable, create, defineProperty, extend, hasOwnProperty, isArray, isFunction, isNumber, isObject, isUndefined;
  ...
  module.exports = Eventable = (function() {
    ...
    function Eventable(aClass) {
      if (this instanceof Eventable) {
        throw TypeError("Eventable a class only");
      }
      if (!aClass.hasOwnProperty('defaultMaxListeners')) {
